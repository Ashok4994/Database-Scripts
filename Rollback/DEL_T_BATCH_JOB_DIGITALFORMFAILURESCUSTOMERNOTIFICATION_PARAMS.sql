/*
  Script:      DEL_T_BATCH_JOB_DIGITALFORMFAILURESCUSTOMERNOTIFICATION_PARAMS.sql
  Author:      siturrioz
  Date:        12/03/2019
...
EXCEPTION
    WHEN OTHERS THEN
        ...
        DBMS_OUTPUT.PUT_LINE('Delete DigitalFormFailuresCustomerNotificationJob parameters SUCCESSFUL on T_BATCH_JOB_PARMS');
END;
/
